...
MAKE_MENU       (main_page,     NULL_ENTRY,     NULL_ENTRY,     NULL_ENTRY,     common_info,    8,          MAIN_PAGE,          "Главное меню");
  ...
  MAKE_MENU     (meas_channels, act_channels,   common_info,    main_page,      meas_ch_0,      16,         MEAS_CHANNELS,      "Изм. каналы");
    MAKE_MENU   (meas_ch_0,     meas_ch_1,      meas_ch_15,     meas_channels,  NULL_ENTRY,     0,          MEAS_CH_0,          "Темп. 1");
    MAKE_MENU   (meas_ch_1,     meas_ch_2,      meas_ch_0,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_1,          "Темп. 2");
    MAKE_MENU   (meas_ch_2,     meas_ch_3,      meas_ch_1,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_2,          "Темп. уср.");
    MAKE_MENU   (meas_ch_3,     meas_ch_4,      meas_ch_2,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_3,          "Вл-ть 1");
    MAKE_MENU   (meas_ch_4,     meas_ch_5,      meas_ch_3,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_4,          "Вл-ть 2");
    MAKE_MENU   (meas_ch_5,     meas_ch_6,      meas_ch_4,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_5,          "Вл-ть уср.");
    MAKE_MENU   (meas_ch_6,     meas_ch_7,      meas_ch_5,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_6,          "Темп. снаружи");
    MAKE_MENU   (meas_ch_7,     meas_ch_8,      meas_ch_6,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_7,          "Вл-ть снаружи");
    MAKE_MENU   (meas_ch_8,     meas_ch_9,      meas_ch_7,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_8,          "Мин ур. Ом");
    MAKE_MENU   (meas_ch_9,     meas_ch_10,     meas_ch_8,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_9,          "Мин ур. АЦП");
    MAKE_MENU   (meas_ch_10,    meas_ch_11,     meas_ch_9,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_10,         "Мин ур. В");
    MAKE_MENU   (meas_ch_11,    meas_ch_12,     meas_ch_10,     meas_channels,  NULL_ENTRY,     0,          MEAS_CH_11,         "Макс ур. Ом");
    MAKE_MENU   (meas_ch_12,    meas_ch_13,     meas_ch_11,     meas_channels,  NULL_ENTRY,     0,          MEAS_CH_12,         "Макс ур. АЦП");
    MAKE_MENU   (meas_ch_13,    meas_ch_14,     meas_ch_12,     meas_channels,  NULL_ENTRY,     0,          MEAS_CH_13,         "Макс ур. В");
  ...
  MAKE_MENU     (act_channels,  rele_channels,  meas_channels,  main_page,      act_ch_0,       6,          ACT_CHANNELS,       "Упр. каналы");
    ...
    MAKE_MENU   (act_ch_2,      act_ch_3,       act_ch_1,       act_channels,   act_en_2,       4,          ACT_CH_2,           "Темп подогрев");
    ...
    MAKE_MENU   (act_ch_3,      act_ch_4,       act_ch_2,       act_channels,   act_en_3,       4,          ACT_CH_3,           "Темп охл");
      ...
      MAKE_MENU (act_cur_3,     act_en_3,       act_hyst_3,     act_ch_3,       NULL_ENTRY,     0,          ACT_CUR_3,          "Текущее");
    MAKE_MENU   (act_ch_4,      act_ch_5,       act_ch_3,       act_channels,   act_en_4,       4,          ACT_CH_4,           "Влажность");
      MAKE_MENU (act_en_4,      act_set_4,      act_cur_4,      act_ch_4,       EDITED_VAL,     0,          ACT_EN_4,           "Управление");
      MAKE_MENU (act_set_4,     act_hyst_4,     act_en_4,       act_ch_4,       EDITED_VAL,     0,          ACT_SET_4,          "Задано");
      MAKE_MENU (act_hyst_4,    act_cur_4,      act_set_4,      act_ch_4,       EDITED_VAL,     0,          ACT_HYST_4,         "Гистерезис");
      MAKE_MENU (act_cur_4,     act_en_4,       act_hyst_4,     act_ch_4,       NULL_ENTRY,     0,          ACT_CUR_4,          "Текущее");
  ...
  MAKE_MENU     (connection,    display,        rele_channels,  main_page,      mdb_addr,       8,          CONNECTION,         "Связь");
