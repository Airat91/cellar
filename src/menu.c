...
MAKE_MENU       (main_page,     NULL_ENTRY,     NULL_ENTRY,     NULL_ENTRY,     common_info,    4,          MAIN_PAGE,          "Главное меню");
  ...
  MAKE_MENU     (act_channels,  rele_channels,  meas_channels,  main_page,      act_ch_0,       13,         ACT_CHANNELS,       "Упр. каналы");
    MAKE_MENU   (act_ch_0,      act_ch_1,       act_ch_3,       act_channels,   act_en_0,       3,          ACT_CH_0,           "Клапан приточный");
      MAKE_MENU (act_en_0,      act_set_0,      act_cur_0,      act_ch_0,       EDITED_VAL,     0,          ACT_EN_0,           "Управление");
      MAKE_MENU (act_set_0,     act_cur_0,      act_en_0,       act_ch_0,       EDITED_VAL,     0,          ACT_SET_0,          "Задано");
      MAKE_MENU (act_cur_0,     act_en_0,       act_set_0,      act_ch_0,       NULL_ENTRY,     0,          ACT_CUR_0,          "Текущее");
    MAKE_MENU   (act_ch_1,      act_ch_2,       act_ch_0,       act_channels,   act_en_1,       3,          ACT_CH_1,           "Клапан вытяжной");
      MAKE_MENU (act_en_1,      act_set_1,      act_cur_1,      act_ch_1,       EDITED_VAL,     0,          ACT_EN_1,           "Управление");
      MAKE_MENU (act_set_1,     act_cur_1,      act_en_1,       act_ch_1,       EDITED_VAL,     0,          ACT_SET_1,          "Задано");
      MAKE_MENU (act_cur_1,     act_en_1,       act_set_1,      act_ch_1,       NULL_ENTRY,     0,          ACT_CUR_1,          "Текущее");
    MAKE_MENU   (act_ch_2,      act_ch_3,       act_ch_1,       act_channels,   act_en_2,       3,          ACT_CH_2,           "Температура");
      MAKE_MENU (act_en_2,      act_set_2,      act_cur_2,      act_ch_2,       EDITED_VAL,     0,          ACT_EN_2,           "Управление");
      MAKE_MENU (act_set_2,     act_cur_2,      act_en_2,       act_ch_2,       EDITED_VAL,     0,          ACT_SET_2,          "Задано");
      MAKE_MENU (act_cur_2,     act_en_2,       act_set_2,      act_ch_2,       NULL_ENTRY,     0,          ACT_CUR_2,          "Текущее");
    MAKE_MENU   (act_ch_3,      act_ch_0,       act_ch_2,       act_channels,   act_en_3,       3,          ACT_CH_3,           "Влажность");
      MAKE_MENU (act_en_3,      act_set_3,      act_cur_3,      act_ch_3,       EDITED_VAL,     0,          ACT_EN_3,           "Управление");
      MAKE_MENU (act_set_3,     act_cur_3,      act_en_3,       act_ch_3,       EDITED_VAL,     0,          ACT_SET_3,          "Задано");
      MAKE_MENU (act_cur_3,     act_en_3,       act_set_3,      act_ch_3,       NULL_ENTRY,     0,          ACT_CUR_3,          "Текущее");
